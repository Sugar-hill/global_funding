...
const FundCard = ({ owner, title, description, target, deadline,
     amountCollected, image, handleClick }) => {
        // const remainingDays = daysLeft(deadline);   ACTIVATE THIS ONCE YOU ENABLE THE DYNAMIC CAMPAIGNS CALL
        

  return (
    <div className="w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
